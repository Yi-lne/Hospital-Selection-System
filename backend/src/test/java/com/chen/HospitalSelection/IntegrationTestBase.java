...
import com.chen.HospitalSelection.config.TestSecurityConfig;
...
public abstract class IntegrationTestBase {
    ...
    /**
     * 测试用的用户ID
     * 注意：schema.sql 中用户 ID=1 是管理员，ID=2 是测试用户（13800000001）
     */
     ...
     * 测试用的另一个用户ID
     */
    protected static final Long TEST_USER_ID_2 = 3L;
