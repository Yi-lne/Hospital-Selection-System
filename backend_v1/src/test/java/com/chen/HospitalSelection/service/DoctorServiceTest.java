...
public class DoctorServiceTest {
    ...
    public void testGetDoctorDetail_Success() {
        ...
        verify(doctorMapper, times(1)).selectById(TEST_DOCTOR_ID);
    ...
    public void testFilterDoctors_ByHospital() {
        ...
        // 实际实现调用selectAll然后内存过滤
        List<Doctor> allDoctors = Arrays.asList(testDoctor, testDoctor2, testDoctor3);
        when(doctorMapper.selectAll()).thenReturn(allDoctors);
    ...
    public void testFilterDoctors_NoResults() {
        ...
        when(doctorMapper.selectAll()).thenReturn(Arrays.asList(testDoctor, testDoctor2, testDoctor3));
