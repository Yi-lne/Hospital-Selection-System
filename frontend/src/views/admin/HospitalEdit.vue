    ...
    >
      ...
      <el-form-item label="医院级别" prop="hospitalLevel">
        <el-select v-model="form.hospitalLevel" placeholder="请选择医院级别">
          <el-option label="三甲" value="grade3A" />
          <el-option label="三乙" value="grade3B" />
          <el-option label="二甲" value="grade2A" />
          <el-option label="二乙" value="grade2B" />
          <el-option label="二丙" value="grade2C" />
          <el-option label="一甲" value="grade1A" />
        </el-select>
      </el-form-item>
...
// 省份改变
const handleProvinceChange = async (clearChildren = true) => {
  if (clearChildren) {
    form.value.cityCode = ''
    form.value.areaCode = ''
  }
...
// 城市改变
const handleCityChange = async (clearChildren = true) => {
  if (clearChildren) {
    form.value.areaCode = ''
  }
  areas.value = []
