        ...
        <el-card class="topic-card">
          <div class="topic-header">
            <div class="author-info">
              <el-avatar :size="48" :src="topicDetail.authorAvatar || defaultAvatar" />
              <div>
                <h3>{{ topicDetail.authorName || '匿名用户' }}</h3>
...
import type { TopicDetail } from '@/types/community'
...
const toggleLikeComment = async (comment: Comment) => {
  ...
  try {
    ...
    console.error('Failed to toggle like comment:', error)
  }
}
