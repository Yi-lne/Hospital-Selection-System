...
export const adminApi = {
   ...
   * 搜索医院
   */
  searchHospitals(keyword, includeDeleted = false) {
    return Request.get('/admin/hospitals/search', { params: { keyword, includeDeleted } })
  },
   ...
   * 获取医院科室列表
   */
  getHospitalDepartments(hospitalId, params) {
    return Request.get(`/department/hospital/${hospitalId}`, { params })
  },
   ...
   */
  banUser(id, data) {
    return Request.put(`/admin/user/${id}/ban`, data)
  },
   ...
   */
  unbanUser(id) {
    return Request.put(`/admin/user/${id}/unban`)
  }
}
